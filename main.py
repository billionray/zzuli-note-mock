...
def run2nd(import_img2,college,grade,major,class_t,name,number,sex,nation,applydate,phone,type,behalf,begin,end,days,year,mouth,day,hour,minute,parents_know,parents_name,parents_phone,where,why,counselor,counselor_name):
    ...
    draw.text((267, 1536),  end, font = font, fill = (60, 60, 60))
    draw.text((267, 1644),  days, font = font, fill = (60, 60, 60))
    draw.text((267, 1732),  parents_know, font = font, fill = (60, 60, 60))
    draw.text((267, 1850),  parents_name, font = font, fill = (60, 60, 60))
    draw.text((267, 1949),  parents_phone, font = font, fill = (60, 60, 60))
    draw.text((267, 2080),  where, font = font, fill = (60, 60, 60))
    draw.text((267, 2196),  why, font = font, fill = (60, 60, 60))
    draw.text((267, 2269),  counselor, font = font, fill = (60, 60, 60))
    draw.text((267, 2316),  counselor_name, font = font, fill = (75, 102, 71))
    draw.text((267, 2368),  passtime, font = font, fill = (60, 60, 60))
    import_img = np.array(img_pil)
    cv2.imshow("export",import_img)
    cv2.waitKey()
